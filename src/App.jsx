  ...
  {/* 2024 SEP */}
        ...
        <div className="main-projects-list">
          ...
          <div className="projects-list-work">
            <a href="https://github.com/ModJuska123/donation-app-php-cli-project"><h4>Charity donation web page</h4></a>
...
{/* 2024 Aug */}
        ...
        <div className="main-projects-list">
          ...
          <div className="projects-list-work">
            <a href="https://github.com/ModJuska123/Madomus"><h4>Web page for construction company</h4></a>
